...
func main() {
	...
	// Prompt for password if not provided (skip for Kerberos or --no-pass)
...
func printUsage() {
	...
	fmt.Println("  -b, --bloodhound  Generate BloodHound CE compatible zip file")
	...
	fmt.Println("  govibe -k -U admin -D corp.local -I 10.10.10.10 -x 127.0.0.1:1080 --dc-host dc01.corp.local")
}
